  ...
  return (
    <section className="space-y-3">
      ...
      <div className="relative" ref={panelRef}>
        ...
        {open && (
          <div className="absolute left-0 top-full z-20 mt-1 w-full max-w-md rounded-md border border-clara-border bg-clara-surface p-2 shadow-card">
            <input
              type="search"
              value={query}
              onChange={(e) => setQuery(e.target.value)}
              placeholder="Search moves…"
              className="mb-2 w-full rounded-md border border-clara-border bg-clara-elevated px-3 py-2 text-sm text-clara-ink placeholder:text-clara-muted/80 focus:border-clara-warm focus:outline-none focus:ring-1 focus:ring-clara-warm/40"
              autoFocus
            />
        ...
        <ul className="space-y-2">
          {moves.map((move, index) => (
            <li
              ...
              className="flex flex-wrap items-end gap-2 rounded-md border border-clara-border bg-clara-elevated px-3 py-2"
            >
